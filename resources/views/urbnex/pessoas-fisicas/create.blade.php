...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('urbnex.pessoasFisicas.store') }}" method="POST" id="formStorePessoaFisica">
            @csrf
            <!--begin::Tabs-->
            <ul class="nav nav-tabs nav-line-tabs mb-6" id="pessoaTabs" role="tablist">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="mb-4">
                                ...
                                <select id="profissao" name="profissao" class="form-select" data-placeholder="Escolha..." autocomplete="off">
                                    <option value="">Escolha...</option>
                                    <!-- Opções serão carregadas via JS -->
                                </select>
                            </div>
